...
import defaultImage from "../assets/JPEG/defaultProfile.jpeg";
...
const Profile = () => {
  ...
  return (
    <>
      ...
      <div className="  lg:mt-32  lg:max-w-[1250px] mx-auto">
        ...
        <div class="font-sans antialiased text-gray-900 leading-normal tracking-wider bg-cover">
          <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
            ...
            <div class="w-full lg:w-2/5">
              <img
                src={
                  profile?.profileUrl ? profile?.profileUrl : placeholderImage
                }
                alt=""
